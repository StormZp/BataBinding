...
import com.storm.tool.R
import com.storm.tool.adapter.VLayoutAdapter
import com.storm.tool.utils.VLayoutHelper
...
open class BaseVlayoutFragment : Fragment() {
    ...
    fun addBackTopButton() {
        ...
        if (backTop == null) {
            backTop = object : VLayoutHelper.Builder() {}.
                ...
                val button = itemView.itemView.findViewById<ImageView>(R.id.back_top)
    ...
    fun initDownRefresh(view: View) {
        val storeHousePtrFrame: PtrFrameLayout = view.findViewById<PtrFrameLayout>(R.id.store_house_ptr_frame)
